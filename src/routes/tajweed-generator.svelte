				...
				<tr>
					<td>
						...
						<select name="surah" id="surah" bind:value={selectedClass}>
							{#each ['madd-4-5', 'madd-2-4-6', 'madd-6', 'ghunnah', 'idgham-syafawi', 'idgham-bighunnah', 'idgham-bilaghunnah', 'idgham-mutamatsilain', 'idgam-mutajanisain', 'ikhfa', 'iqlab', 'qalqalah'] as tjwClass}
